...
suite "Interpreter tests":
  test "Type promotion edge cases":
    check evalString("2 + 3.0").number.real == 5.0
    check evalString("5 / 2").number.real == 2.5
    check evalString("2 ^ 0.5").number.real == sqrt(2.0)
  ...
  test "Division and modulo edge cases":
    ...
    check evalString("5 % 0.999").number.real == 0.0050000000000000044
    check evalString("-7 % 3").number.integer == -1
  ...
  test "Higher-order function evaluation":
    ...
    check res.number.integer == 70

  test "Vector operations":
    ## Test element-wise addition between two vectors.
    ## Syntax example: [1,2,3] + [4,5,6] equals [5,7,9]
    let res = evalString("[1, 2, 3] + [4, 5, 6]")
    check res.vector[0].number.integer == 5
    check res.vector[1].number.integer == 7
    check res.vector[2].number.integer == 9
  ...
  test "Complex division and exponentiation":
    ...
    check resDiv.number.complex == complex(0.0, -2.0)
    ## Exponentiation: (3i)^2 equals -9.
    let resPow = evalString("3i ^ 2")
    check resPow.number.real == -9.0
  ...
  test "Exception handling for scope and variable issues":
    ...
    check scopeResult.number.integer == 10
  ...
  test "Arrow operator chaining with addition":
    ...
    let res = evalString("""
      ...
      4->double + 4->double
    """)
    check res.number.integer == 16  # (4+4) + (4+4)
  ...
  test "Arrow operator with vector operations":
    ...
    check res.vector[1].number.integer == 8
  ...
  test "Nested conditionals with arrows and vectors":
    ...
    check res2.vector[1].number.integer == 12
    check res2.vector[2].number.integer == 18
