  ...
  let newBody = quote do:
    try:
      ...
      if e.msg.contains("Ceiling"):
        raise newUnsupportedTypeError("Ceiling operation not supported for complex numbers")
      elif e.msg.contains("Floor"):
        raise newUnsupportedTypeError("Floor operation not supported for complex numbers")
      else:
        raise newUnsupportedTypeError("Round operation not supported for complex numbers")
